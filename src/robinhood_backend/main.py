...
@app.get("/l2-chart")
async def get_l2_chart(symbol:str, min_price:Optional[int|float]=None, max_price:Optional[int|float]=None):
    return JSONResponse(content = json.loads(utils.l2_chart(symbol, min_price, max_price)))